...
- `./build/gfx_window_demo` abre uma janela nativa Linux com contexto GLX e apresenta frames OpenGL reais; em ambiente headless, rode-o sob `xvfb-run`.
...
- Parser `.obj`/`.mtl` próprio
- Extra: framebuffer Linux (`/dev/fb0`)
- Extra: janela Linux/X11/OpenGL via `dlopen`
- Demos e testes

### 🔭 Próximos passos
- Backend bare-metal (framebuffer linear entregue por bootloader, ex.: para o [AlmaOS](https://github.com/Gabryel-lima/AlmaOS))
- Texturas com correção perspectiva, iluminação Phong, sombras
